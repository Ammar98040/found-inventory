...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write('  1. Add more products through the main interface')
        self.stdout.write('  2. Test the search system')
        self.stdout.write('  3. Go to /manage/ to manage warehouse grid')
