...
ALLOWED_HOSTS = ['*']  # للسماح بجميع المضيفين على Render
...
# استخدام PostgreSQL على Render مع fallback إلى SQLite للتطوير المحلي
DATABASES = {
    'default': {
...
# Fallback إلى SQLite إذا لم يتم تحديد PostgreSQL
try:
